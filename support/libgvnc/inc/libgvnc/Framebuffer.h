 ...
 * Author: harry
 *
 * Created on 08 May 2018, 15:40
 */

#ifndef LIBGVNC_FRAMEBUFFER_H
#define LIBGVNC_FRAMEBUFFER_H
...
namespace libgvnc {
	...
	public:
		...
		const struct FB_PixelFormat &GetPixelFormat() const { return pixel_format_; }
