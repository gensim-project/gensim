	...
	while(tpsa.Good()) {
		...
		switch(tr.GetType()) {
			...
			case RegWrite:
				...
				break;
			case BankRegRead:
				printf("Bank Reg Read");
				break;
			case BankRegWrite:
				printf("Bank Reg Write");
				break;
			case MemReadAddr:
				printf("Mem Read Addr");
				break;
			case MemReadData:
				printf("Mem Read Data");
				break;
			case MemWriteAddr:
				printf("Mem Write Addr");
				break;
			case MemWriteData:
