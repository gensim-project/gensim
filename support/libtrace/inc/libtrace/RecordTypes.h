...
namespace libtrace
{
	...
	public:
		...
		TraceRecordType GetType() const
		{
			return (TraceRecordType)(GetHeader() >> 24);
		}
		uint8_t GetExtensionCount() const
		{
			return (TraceRecordType)(GetHeader() >> 16);
		}
	...
	public:
		...
		uint32_t GetData() const
		{
			return GetData32() & ((1ULL << (GetWidth()*8))-1);
		}
	};
