...
static uint32_t MapSym(uint32_t xsym)
{
	switch(xsym) {
		...
		case '`':
			return 0; //todo
//		case '¬':
//			return 0; //todo almagni: this character cannot be encoded in 1 byte.
		case '!':
			return 0; //todo
		case '"':
			return 0; //todo
...
//			return 0; //todo almagni: this character cannot be encoded in 1 byte.
		...
		case 0xff1b:
			return 0x76; // escape
		case 0xff63:
			return 0xe070; // insert
		case 0xffff:
			return 0xe071; // delete
		case 0xff50:
			return 0xe06c; // home
		case 0xff57:
			return 0xe069; // end
		case 0xff55:
			return 0xe07d; // page up
		case 0xff56:
			return 0xe07a; // page down
