...
namespace archsim {
		...
		public:
			RegisterFileEntryInterface(size_t offset, size_t size_in_elements, size_t element_stride) : offset_(offset), size_in_elements_(size), element_stride_(element_stride) {}
